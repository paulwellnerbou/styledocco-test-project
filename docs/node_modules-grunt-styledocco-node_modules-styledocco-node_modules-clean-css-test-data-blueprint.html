<!DOCTYPE html><html><head><title>blueprint | styledocco-test-project
...
<p>   reset.css</p>
<ul>
<li>Resets default browser CSS.</li>
</ul>
<hr>
<p> This helps to make newer HTML5 elements behave like DIVs in older browers  </p>
<p> Line-height should always be unitless! </p>
<p> Tables still need &#39;cellspacing=&quot;0&quot;&#39; in the markup. </p>
<p> float:none prevents the span-x classes from breaking table-cell display </p>
<p> Remove possible quote marks (&quot;) from <q>, <blockquote>. </p>
<p> Remove annoying border on linked images. </p>
<p> Remember to define your own focus styles! </p>
<hr>
<p>   typography.css</p>
<ul>
<li>Sets up some sensible default typography.</li>
</ul>
<hr>
<p> Default font settings.
   The font-size percentage is of 16px. (0.75 * 16px = 12px) </p>
<h2 id="headings"> Headings</h2>
<h2 id="text-elements"> Text elements</h2>
<textarea class="preview-code" spellcheck="false">These can be used to pull an image at the start of a paragraph, so 
that the text flows around it (usage: &lt;p&gt;&lt;img class="left"&gt;Text&lt;/p&gt;) </textarea><h2 id="lists"> Lists</h2>
<h2 id="tables"> Tables</h2>
<textarea class="preview-code" spellcheck="false">Because of the need for padding on TH and TD, the vertical rhythm 
on table cells has to be 27px, instead of the standard 18px or 36px 
of other elements. </textarea><textarea class="preview-code" spellcheck="false">You can zebra-stripe your tables in outdated browsers by adding 
the class "even" to every other table row. </textarea><h2 id="misc-classes"> Misc classes</h2>
<hr>
<p>   forms.css</p>
<ul>
<li>Sets up some default styling for forms</li>
<li><p>Gives you classes to enhance your forms</p>
<p>Usage:</p>
</li>
<li>For text fields, use class .title or .text</li>
<li>For inline forms, use .inline (even when using columns)</li>
</ul>
<hr>
<textarea class="preview-code" spellcheck="false">A special hack is included for IE8 since it does not apply padding 
correctly on fieldsets</textarea><h2 id="form-fields"> Form fields</h2>
<p>  Attribute selectors are used to differentiate the different types 
  of input elements, but to support old browsers, you will have to 
  add classes for each one. &quot;.title&quot; simply creates a large text<br>  field, this is purely for looks.</p>
<p>  This is to be used on forms where a variety of elements are 
  placed side-by-side. Use the p tag to denote a line. </p>
<h2 id="success-info-notice-and-erroralert-boxes"> Success, info, notice and error/alert boxes</h2>
<hr>
<p>   grid.css</p>
<ul>
<li><p>Sets up an easy-to-use grid of 24 columns.</p>
<p>By default, the grid is 950px wide, with 24 columns
spanning 30px, and a 10px margin between columns.</p>
<p>If you need fewer or more columns, namespaces or semantic
element names, use the compressor script (lib/compress.rb)</p>
</li>
</ul>
<hr>
<p> A container should group all your columns. </p>
<p> Use this class on any .span / container to see the grid. </p>
<h2 id="columns"> Columns</h2>
<p> Sets up basic grid floating and margin. </p>
<p> The last column in a row needs this class. </p>
<p> Use these classes to set the width of a column. </p>
<p> Use these classes to set the width of an input. </p>
<p> Add these to a column to append empty cols. </p>
<p> Add these to a column to prepend empty cols. </p>
<p> Border on right hand side of a column. </p>
<p> Border with more whitespace, spans one column. </p>
<p> Use these classes on an element to push it into the
next column, or to pull it into the previous column.  </p>
<h2 id="misc-classes-and-elements"> Misc classes and elements</h2>
<p> In case you need to add a gutter above/below an element </p>
<p> Use a .box to create a padded box inside a column.  </p>
<p> Use this to create a horizontal ruler across a column. </p>
<p> Clearing floats without extra markup
   Based on How To Clear Floats Without Structural Markup by PiE
   [<a href="http://www.positioniseverything.net/easyclearing.html">http://www.positioniseverything.net/easyclearing.html</a>] </p>
<p> Regular clearing
   apply to column that should drop below previous ones. </p>
