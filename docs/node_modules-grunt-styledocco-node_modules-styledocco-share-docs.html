...
.code {
  ...
  .code:hover {
    opacity: 1;
  }</code></pre></div></article><article id="previews-and-code" class="section"><div class="docs"><a href="#previews-and-code" class="permalink"><svg viewBox="0 0 512 512" height="32" width="32" class="icon"><path d="M156.2,199.7c7.5-7.5,15.9-13.8,24.8-18.7c49.6-27.3,113.1-12.8,145,35.5l-38.5,38.5c-11.1-25.2-38.5-39.6-65.8-33.5c-10.3,2.3-20.1,7.4-28,15.4l-73.9,73.9c-22.4,22.4-22.4,58.9,0,81.4c22.4,22.4,58.9,22.4,81.4,0l22.8-22.8c20.7,8.2,42.9,11.5,64.9,9.9l-50.3,50.3c-43.1,43.1-113,43.1-156.1,0c-43.1-43.1-43.1-113-0-156.1L156.2,199.7z M273.6,82.3l-50.3,50.3c21.9-1.6,44.2,1.6,64.9,9.9l22.8-22.8c22.4-22.4,58.9-22.4,81.4,0c22.4,22.4,22.4,58.9,0,81.4l-73.9,73.9c-22.5,22.5-59.1,22.3-81.4,0c-5.2-5.2-9.7-11.7-12.5-18l-38.5,38.5c4,6.1,8.3,11.5,13.7,16.9c13.9,13.9,31.7,24.3,52.1,29.3c26.5,6.4,54.8,2.8,79.2-10.6c8.9-4.9,17.3-11.1,24.8-18.7l73.9-73.9c43.1-43.1,43.1-113,0-156.1C386.6,39.2,316.7,39.2,273.6,82.3z"></path></svg></a><h1 id="previews-and-code">Previews and code</h1>
<p>Previews are rendered in sandboxed iframes with the documented CSS applied.
The code is editable and the previews will be automatically updated.</p>
<p>The width of the previews can be adjusted to test responsive designs. The
...
only enlarge the previews and other browsers have not implemented CSS <code>resize</code>
</small>. </p>
<p>Editable code blocks have a desaturated orange background. They will be
automatically resized to fit the text inside.</p>
<textarea class="preview-code" spellcheck="false">&lt;textarea class="preview-code"&gt;Code&lt;/textarea&gt;</textarea><p> Previews are placed in a resizeable container as <code>iframe</code> elements cannot be
resized with the CSS <code>resize</code> property. </p>
<p> No code is allowed to overflow horizontally. </p>
</div><div class="code"><pre><code>.preview {
...
.code pre {
  height: 100%;
  margin-top: 0;
}</code></pre></div></article><article id="navigation" class="section"><div class="docs"><a href="#navigation" class="permalink"><svg viewBox="0 0 512 512" height="32" width="32" class="icon"><path d="M156.2,199.7c7.5-7.5,15.9-13.8,24.8-18.7c49.6-27.3,113.1-12.8,145,35.5l-38.5,38.5c-11.1-25.2-38.5-39.6-65.8-33.5c-10.3,2.3-20.1,7.4-28,15.4l-73.9,73.9c-22.4,22.4-22.4,58.9,0,81.4c22.4,22.4,58.9,22.4,81.4,0l22.8-22.8c20.7,8.2,42.9,11.5,64.9,9.9l-50.3,50.3c-43.1,43.1-113,43.1-156.1,0c-43.1-43.1-43.1-113-0-156.1L156.2,199.7z M273.6,82.3l-50.3,50.3c21.9-1.6,44.2,1.6,64.9,9.9l22.8-22.8c22.4-22.4,58.9-22.4,81.4,0c22.4,22.4,22.4,58.9,0,81.4l-73.9,73.9c-22.5,22.5-59.1,22.3-81.4,0c-5.2-5.2-9.7-11.7-12.5-18l-38.5,38.5c4,6.1,8.3,11.5,13.7,16.9c13.9,13.9,31.7,24.3,52.1,29.3c26.5,6.4,54.8,2.8,79.2-10.6c8.9-4.9,17.3-11.1,24.8-18.7l73.9-73.9c43.1-43.1,43.1-113,0-156.1C386.6,39.2,316.7,39.2,273.6,82.3z"></path></svg></a><h1 id="navigation">Navigation</h1>
<p>Fixed to top with a small drop shadow.</p>
<textarea class="preview-code" spellcheck="false">&lt;nav class="bar top"&gt;&lt;/nav&gt;</textarea><textarea class="preview-code" spellcheck="false">&lt;div class="bar top"&gt;&lt;a href="#" class="brand"&gt;Site name&lt;/a&gt;&lt;/div&gt;</textarea><h2 id="dropdown-and-search">Dropdown and search</h2>
<textarea class="preview-code" spellcheck="false">&lt;div class="bar top"&gt;
  &lt;ul class="menu"&gt;
  ...
  &lt;/ul&gt;
&lt;/div&gt;</textarea>
</div><div class="code"><pre><code>.bar {
  position: fixed;
  left: 0; right: 0;
  z-index: 1010;
  min-height: 40px;
...
.nav input[type="search"] {
  ...
  }</code></pre></div></article><article id="settings-and-configuration" class="section"><div class="docs"><a href="#settings-and-configuration" class="permalink"><svg viewBox="0 0 512 512" height="32" width="32" class="icon"><path d="M156.2,199.7c7.5-7.5,15.9-13.8,24.8-18.7c49.6-27.3,113.1-12.8,145,35.5l-38.5,38.5c-11.1-25.2-38.5-39.6-65.8-33.5c-10.3,2.3-20.1,7.4-28,15.4l-73.9,73.9c-22.4,22.4-22.4,58.9,0,81.4c22.4,22.4,58.9,22.4,81.4,0l22.8-22.8c20.7,8.2,42.9,11.5,64.9,9.9l-50.3,50.3c-43.1,43.1-113,43.1-156.1,0c-43.1-43.1-43.1-113-0-156.1L156.2,199.7z M273.6,82.3l-50.3,50.3c21.9-1.6,44.2,1.6,64.9,9.9l22.8-22.8c22.4-22.4,58.9-22.4,81.4,0c22.4,22.4,22.4,58.9,0,81.4l-73.9,73.9c-22.5,22.5-59.1,22.3-81.4,0c-5.2-5.2-9.7-11.7-12.5-18l-38.5,38.5c4,6.1,8.3,11.5,13.7,16.9c13.9,13.9,31.7,24.3,52.1,29.3c26.5,6.4,54.8,2.8,79.2-10.6c8.9-4.9,17.3-11.1,24.8-18.7l73.9-73.9c43.1-43.1,43.1-113,0-156.1C386.6,39.2,316.7,39.2,273.6,82.3z"></path></svg></a><h1 id="settings-and-configuration">Settings and configuration</h1>
</div><div class="code"><pre><code>.settings {
  text-align: center;
}
.bar button {
  display: inline-block;
...
}</code></pre></div></article><article id="typography-and-text-styles" class="section"><div class="docs"><a href="#typography-and-text-styles" class="permalink"><svg viewBox="0 0 512 512" height="32" width="32" class="icon"><path d="M156.2,199.7c7.5-7.5,15.9-13.8,24.8-18.7c49.6-27.3,113.1-12.8,145,35.5l-38.5,38.5c-11.1-25.2-38.5-39.6-65.8-33.5c-10.3,2.3-20.1,7.4-28,15.4l-73.9,73.9c-22.4,22.4-22.4,58.9,0,81.4c22.4,22.4,58.9,22.4,81.4,0l22.8-22.8c20.7,8.2,42.9,11.5,64.9,9.9l-50.3,50.3c-43.1,43.1-113,43.1-156.1,0c-43.1-43.1-43.1-113-0-156.1L156.2,199.7z M273.6,82.3l-50.3,50.3c21.9-1.6,44.2,1.6,64.9,9.9l22.8-22.8c22.4-22.4,58.9-22.4,81.4,0c22.4,22.4,22.4,58.9,0,81.4l-73.9,73.9c-22.5,22.5-59.1,22.3-81.4,0c-5.2-5.2-9.7-11.7-12.5-18l-38.5,38.5c4,6.1,8.3,11.5,13.7,16.9c13.9,13.9,31.7,24.3,52.1,29.3c26.5,6.4,54.8,2.8,79.2-10.6c8.9-4.9,17.3-11.1,24.8-18.7l73.9-73.9c43.1-43.1,43.1-113,0-156.1C386.6,39.2,316.7,39.2,273.6,82.3z"></path></svg></a><h1 id="typography-and-text-styles">Typography and text styles</h1>
<p>We use the generic <code>sans-serif</code> font family to get Arial on Windows and
Helvetica on Mac. The body font-size is set to 14px.</p>
<textarea class="preview-code" spellcheck="false">Lorem ipsum dolor sit amet. </textarea><p> Paragraphs, lists, tables and blockquotes get some bottom margins as well
as side margins.</p>
<textarea class="preview-code" spellcheck="false">&lt;p&gt;Paragraph #1
&lt;p&gt;Paragraph #2
&lt;ul&gt;&lt;li&gt;List&lt;/ul&gt; </textarea><p> Headings get font-sizes at a modular scale of 5:6.</p>
<textarea class="preview-code" spellcheck="false">&lt;h1&gt;Heading 1&lt;/h1&gt;
&lt;h2&gt;Heading 2&lt;/h2&gt;
&lt;h3&gt;Heading 3&lt;/h2&gt;
&lt;h4&gt;Heading 4&lt;/h2&gt;
&lt;h5&gt;Heading 5&lt;/h2&gt;
&lt;h6&gt;Heading 6&lt;/h3&gt; </textarea>
</div><div class="code"><pre><code>body {
...
<p>To show pseudo selectors styles in previews, add the pseudo selector
(including the <code>:</code>) as a regular class.</p>
<textarea class="preview-code" spellcheck="false">&lt;a href="#"&gt;Link&lt;/a&gt;
&lt;a href="#" class=":hover"&gt;Link&lt;/a&gt;
&lt;a href="#" class=":visited"&gt;Link&lt;/a&gt;</textarea>
  ...
  }</code></pre></div></article><article id="code" class="section"><div class="docs"><a href="#code" class="permalink"><svg viewBox="0 0 512 512" height="32" width="32" class="icon"><path d="M156.2,199.7c7.5-7.5,15.9-13.8,24.8-18.7c49.6-27.3,113.1-12.8,145,35.5l-38.5,38.5c-11.1-25.2-38.5-39.6-65.8-33.5c-10.3,2.3-20.1,7.4-28,15.4l-73.9,73.9c-22.4,22.4-22.4,58.9,0,81.4c22.4,22.4,58.9,22.4,81.4,0l22.8-22.8c20.7,8.2,42.9,11.5,64.9,9.9l-50.3,50.3c-43.1,43.1-113,43.1-156.1,0c-43.1-43.1-43.1-113-0-156.1L156.2,199.7z M273.6,82.3l-50.3,50.3c21.9-1.6,44.2,1.6,64.9,9.9l22.8-22.8c22.4-22.4,58.9-22.4,81.4,0c22.4,22.4,22.4,58.9,0,81.4l-73.9,73.9c-22.5,22.5-59.1,22.3-81.4,0c-5.2-5.2-9.7-11.7-12.5-18l-38.5,38.5c4,6.1,8.3,11.5,13.7,16.9c13.9,13.9,31.7,24.3,52.1,29.3c26.5,6.4,54.8,2.8,79.2-10.6c8.9-4.9,17.3-11.1,24.8-18.7l73.9-73.9c43.1-43.1,43.1-113,0-156.1C386.6,39.2,316.7,39.2,273.6,82.3z"></path></svg></a><h1 id="code">Code</h1>
<p>For displaying code, we prefer <a href="http://font.ubuntu.com">Ubuntu Mono</a>,
falling back on some fonts that should look better at smaller sizes than the
default monospace fonts.</p>
<textarea class="preview-code" spellcheck="false">&lt;pre&gt;
&lt;code&gt;The font in &lt;pre&gt; code blocks is small but legible.&lt;/code&gt;
&lt;/pre&gt;</textarea><pre><code class="lang-php">&lt;?php
echo &quot;Hello World;
?&gt;</code></pre>
<p> Helper classes </p>
</div><div class="code"><pre><code>.preview-code,
pre, code, var {
  font-style: normal;
